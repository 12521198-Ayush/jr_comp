...
export default function TECCertificationPage() {
  return (
    <ServicePageTemplate
      ...
      trustedBy={['Cisco', 'Huawei', 'Nokia', 'Ericsson', 'ZTE']}
      benefits={[
      ...
      faqs={[
        {
          question: 'Who needs TEC certification in India?',
          answer: 'All enterprises who produce, import, or distribute telecom equipment in India need TEC certification to comply with regulatory requirements.',
        },
        {
          question: 'How long is TEC certification valid?',
          answer: 'Thanks to government reforms, TEC certificates in India now last for 10 years instead of 5, offering businesses longer validity.',
        },
        {
          question: 'Is TEC certification transferable?',
          answer: 'No, TEC certification is non-transferable. It belongs solely to the applicant who submitted the product for testing.',
        },
        {
          question: 'What happens if a product fails testing?',
          answer: 'If the product fails, the applicant must rectify issues and reapply. This ensures all telecom equipment meets safety requirements.',
        },
        {
          question: 'What is the difference between Type Approval and Interface Approval?',
          answer: 'Type Approval confirms products meet GR standards, while Interface Approval validates equipment can interact within network systems based on IR standards.',
        },
      ]}
    />
  );
